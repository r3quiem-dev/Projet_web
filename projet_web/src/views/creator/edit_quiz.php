...
<head>
    ...
    <style>
        ...
        body { 
            font-family: 'Segoe UI', sans-serif; background-color: #f0f0f0; color: var(--font-color); padding: 20px; display: flex; justify-content: center;
            flex-direction: column;
            align-items: center;}
        .container { 
            max-width: 800px; width: 100%; background: var(--bg-color); padding: 30px; border-radius: 5px; border: 2px solid var(--main-color); box-shadow: var(--shadow); }
